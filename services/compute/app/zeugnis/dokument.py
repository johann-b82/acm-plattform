...
Der Fließtext kommt aus ``zeugnis.abschnitte`` (Baukasten oder KI, danach
...
def baue_docx(
    ...
    *,
    ...
    abschnitte = zeugnis.abschnitte or {}
...
async def baue_pdf(docx: bytes) -> bytes:
    """Das fertige DOCX nach PDF wandeln — derselbe Weg wie bei den übrigen
    Formblättern."""
    return await nach_pdf(docx, name="zeugnis", endung="docx")
