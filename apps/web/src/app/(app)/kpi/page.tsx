...
/** Die Fachbereiche des KPI-Dashboards. Vertrieb ist portiert, der Rest folgt
...
const BEREICHE = [
  ...
  { path: "/kpi/einkauf", name: "Einkauf", beschreibung: "Liefertreue der Lieferanten", bereit: false },
