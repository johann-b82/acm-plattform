...
| Newsletter, Feedback, KPI-Review | `newsletter.py`, `feedback.py`, `kpi_review.py` | Umbau | CRUD nach PostgREST; Newsletter-PDF bleibt `compute`; Bilder nach Storage mit Magic-Byte-Prüfung. |
