...
| Fachmodul Qualität | Audit-Findings und Reklamationsquote (On Quality) aus den 8D-Berichten, mit Wareneingängen als Bezugsgröße. Prüfmengen folgen. |
...
Tests: 195 in `compute`, 35 in `apps/web`. CI prüft Guards, Compute und Web.
